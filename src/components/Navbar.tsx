    ...
    <nav className="w-full py-6 flex justify-center fixed top-0 z-50">
      <div className="rounded-full w-[850px] max-lg:w-[800px] max-[400px]:w-[345px] max-[450px]:w-[400px] px-2 py-1 bg-white bg-opacity-10 backdrop-blur-md border dark:border-white/20 flex items-center justify-center dark:shadow-none shadow">
        <div className="flex justify-center px-2 items-center max-sm:gap-4 gap-8 max-[400px]:gap-4 max-[450px]:gap-5 transition-all">
          ...
          <Link
            // href="https://drive.google.com/file/d/1WSCVBGTU67gzFLItkNpbkYrEfGlmykIr/view?usp=sharing"
            href="https://drive.google.com/file/d/1TPuUBViuy_z4mynRVnjmFi47ke_hycjF/view?usp=sharing"
            target="_blank"
            underline="none"
          >
          ...
          <Link href="https://github.com/pratyushsingha" target="_blank">
          ...
          <Link href="https://x.com/pratyushsinghaa" target="_blank">
            <Tooltip content="X">
              <div className="hover:px-3 max-sm:hover:px-2 py-2.5 dark:hover:bg-[#262626] hover:bg-[#F4F4F5] rounded-full transition-all duration-300">
          ...
          <Link
            href="https://www.linkedin.com/in/pratyushsingha/"
            target="_blank"
          >
